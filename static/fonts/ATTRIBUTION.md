...
The `latin-ext` subset is required even for an English course: the site chrome
and the task rubrics are German, and the units teach names and loanwords well
outside basic Latin.
