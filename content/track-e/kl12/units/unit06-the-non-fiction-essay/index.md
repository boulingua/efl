---
page_type: unit
title: "Unit 6 — The Non-Fiction Essay"
...
track: "e"
unit_nr: 6
material_slug: "track-e_kl12_unit06-the-non-fiction-essay"
bildungsplan:
...
presentation:
  file: "/efl/materials/presentations/track-e_kl12_unit06-the-non-fiction-essay.pdf"
...
1. Match: anecdote-as-argument → small story doing argumentative work; moral turn → the essay's ethical shift; elliptical close → unfinished but resonant ending.
2. T or F: the essayist's *I* is the same as the fiction-writer's narrator; non-fiction essays always open with the thesis.

### Niveau E — productive

3. Build 3 sentences using essayistic-prose vocabulary on Smith's opening.

{{< callout type="tip" title="Answer key" collapse="true" >}}
**Controlled.** 1. all true.
2. F (different conventions: the essayist's *I* carries personal accountability), F (often the thesis lands later, after an anecdote).
