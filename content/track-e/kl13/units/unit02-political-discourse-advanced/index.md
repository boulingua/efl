...
presentation:
  file: /materials/presentations/e/kl13/unit02_political-discourse-advanced.pptx
  thumbnail: /materials/presentations/e/kl13/unit02_political-discourse-advanced.png
worksheet:
...
1. Match: dog whistle → coded signal to a base; whataboutism → deflect via counter-accusation; scripted spontaneity → rehearsed casualness.
2. T or F: agenda-control means refusing to answer; register-shifting means changing accent; loaded antithesis hides agreement inside contrast.

### Niveau E — productive

3. Identify in each PMQs paraphrase: agenda-control tactic + register-shift + one rhetorical move.

{{< callout type="tip" title="Answer key" collapse="true" >}}
**Controlled.** 1. all true.
2. F (agenda-control means redirecting), F (register-shifting = formal-to-informal etc.), T.
...
1. Loaded antithesis: ___ . 2. Topic migration: ___ . 3. Dog whistle: ___ . 4. Documented since: ___ .

### Analysis

Read the three PMQs paraphrases above.

1. Speaker A's tactic: ___ . 2. Speaker B's tactic: ___ . 3. Speaker C's tactic: ___ . 4. The shared feature: ___ .
