...
track: "e"
unit_nr: 7
material_slug: "track-e_kl10_unit07-mediation-feature-article"
bildungsplan:
...
*Voice* — keep the speaker's voice via reported speech with the right verb (*admitted, claimed, added, argued*).
*Register* — match the addressee. A peer-message drops the *Bürgermeisterin* honorifics; a public-admin reader keeps role + name.
*Hedge* — preserve the journalist's hedging (*Critics argue …*) without inventing certainty.
...
1. Match German verb → English: zugeben → ?, behaupten → ?, hinzufügen → ?, abstreiten → ?
2. Choose the most accurate verb for: *Vogel said: 'I didn't expect it to work, but people came.'*
...
**Controlled.** 1. admit / claim / add / deny.
2. *admitted* (it carries the surprise that *said* would lose).
