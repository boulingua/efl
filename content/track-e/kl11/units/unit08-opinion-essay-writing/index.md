...
1. 300-word demand: ___ . 2. 700-word permission: ___ . 3. 1,400-word capacity: ___ . 4. Length is: ___ .

### Part B — Analysis (~18 BE)

Read the *Opinion at three lengths* extract.

1. 300-word constraint: ___ . 2. 700-word allowance: ___ . 3. 1,400-word affordance: ___ . 4. Length determines: ___ .

### Part C — Composition (~18 BE)

**Cohesion device.**

1. Build a 4-link lexical chain for *the cap on rent increases*: ___ → ___ → ___ → ___
2. Insert *however / accordingly / in this regard*: (contrast / consequence / specification).
3. Anaphoric reference for *the four-day school week*: ___ .
4. Conjunctive adverb for *addition* in formal register: ___ .
